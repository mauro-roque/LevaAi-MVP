...
import { hashPassword, verifyPassword, signToken, verifyToken } from '../src/auth.mjs';
...
test('senha PBKDF2 e JWT do Worker são verificados sem expor segredo', async () => {
  ...
  assert.equal(await verifyToken(token, 'segredo-errado-com-mais-de-32-caracteres'), null);
});
